...
The built code is mapped in [CONTEXT.md](docs/hosted-web-phases/CONTEXT.md); known-red tests are
explained in [KNOWN_RED.md](docs/hosted-web-phases/KNOWN_RED.md); lane-velocity guidance lives in
[VELOCITY.md](docs/hosted-web-phases/VELOCITY.md) (reference, not mandatory).
