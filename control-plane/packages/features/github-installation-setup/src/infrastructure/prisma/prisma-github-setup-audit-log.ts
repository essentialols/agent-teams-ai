...
import type { GitHubSetupAuditLog } from "../../application/ports/policies.js";

@Injectable()
export class PrismaGitHubSetupAuditLog implements GitHubSetupAuditLog {
  public constructor(
  ...
  public async record(
    input: Parameters<GitHubSetupAuditLog["record"]>[0],
  ): Promise<void> {
