...
import { numberValue, stringValue, } from "./codex-goal-mcp-values.js";
import { dryRunCodexGoalLaunch, inspectCodexGoalDoctor, inspectCodexGoalStatus, startCodexGoalLaunch, tailCodexGoalRunLog, } from "./application/codex-goal-operation-use-cases.js";
...
export function registerCodexGoalInspectionTools(server) {
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await inspectCodexGoalStatus({
    ...
    }, async (args) => withMcpErrors(async () => mcpJson(await tailCodexGoalRunLog({
        cwd: stringValue(args.cwd),
        jobRootDir: stringValue(args.jobRootDir),
        taskId: stringValue(args.taskId),
        logPath: stringValue(args.logPath),
