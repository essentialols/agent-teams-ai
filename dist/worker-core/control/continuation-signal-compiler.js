export function compileWorkerControlSignalsForContinuation(signals) {
    if (signals.length === 0)
        return undefined;
    const items = signals
        .slice()
...
export function compareWorkerControlSignals(left, right) {
...
//# sourceMappingURL=continuation-signal-compiler.js.map