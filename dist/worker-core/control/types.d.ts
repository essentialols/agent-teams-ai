...
export interface WorkerControlAuthorizationPolicy {
    authorizeWorkerControl(input: WorkerControlAuthorizationInput): Promise<WorkerControlAuthorizationDecision> | WorkerControlAuthorizationDecision;
}
...
export interface WorkerControlInboxStore {
    ...
    listSignals(query?: Pick<ListWorkerControlSignalsQuery, "target" | "signalIds">): Promise<readonly WorkerControlSignal[]>;
