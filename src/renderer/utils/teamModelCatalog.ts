...
const TEAM_PROVIDER_MODEL_OPTIONS: Record<SupportedProviderId, readonly TeamProviderModelOption[]> =
  {
    ...
    codex: [
      { value: '', label: 'Default', badgeLabel: 'Default' },
      { value: 'gpt-5.6-sol', label: 'GPT-5.6 Sol', badgeLabel: '5.6-sol' },
      { value: 'gpt-5.6-terra', label: 'GPT-5.6 Terra', badgeLabel: '5.6-terra' },
      { value: 'gpt-5.6-luna', label: 'GPT-5.6 Luna', badgeLabel: '5.6-luna' },
