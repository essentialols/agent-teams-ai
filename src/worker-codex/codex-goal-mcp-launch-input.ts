...
import { defaultCodexGoalAuthRoot } from "./codex-goal-mcp-accounts";
import {
...
import type { GoalMcpArgs } from "./codex-goal-mcp-inputs";
import {
  accountNames,
  booleanValue,
...
export async function goalLaunchInput(args: GoalMcpArgs): Promise<CodexGoalLaunchInput> {
